...
function buildCommonRules({ query, resultLimit, candidateLimit }) {
  return [
    ...
    '',
    '- CRITICO: usa price:null se il prezzo non appare testualmente nel risultato di ricerca che stai leggendo. NON stimare, NON ricordare, NON inventare.',
    '- Il campo priceText deve essere copiato letteralmente dal testo del risultato web, non riformattato.',
    '- Se il prezzo sul sito potrebbe essere diverso da quello nel snippet di ricerca, usa price:null.',
